...
<script type="text/javascript">
    ...
    function addRow(){
         var tr = '<tr>'+'<input type="hidden" name="id[]" id="id">'
                        +'<td><label for="name">Nom de la matiere <span class="text-danger">*</span></label><select name="id_matiere[]" id="id_matiere" class="form-control" required="on"></select></td>' 
                        +'<td><label for="slug">coef/credit <span class="text-danger">*</span></label>'
                        +'<input type="number" maxlength="1" class="form-control" id="credits" name="credits[]"  placeholder="ex: 2" required="on" value="">'
                        +'<div class="alert-message" ></td><td> <a href="#" class="btn btn-danger movRow"><i class="fa fa-minus-circle"></i></a></td>'+'</tr>';
