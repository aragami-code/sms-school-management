...
@section('title')
liste des Cycles| Tableau de Bord
@endsection
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Tous les Cycles</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">liste des Cycles </h4>
                    @include('backend.layouts.partials.messages')
                    @if(Auth::guard('admin')->user()->can('cycle.create'))
                    <p class="float-right">{{--
                    ...
                    @if(Auth::guard('admin')->user()->can('cycle.view'))
                    <div class="data-tables">
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    <th width="20%">Nom du cycle</th>
                            ...
                            <tbody id="posts-crud">
                              ...
                              <tr id="id_{{ $classes->id }}">
                                <td>{{$classes->nom_cycle}}</td>
                        

                                    <td>

                                        @if(Auth::guard('admin')->user()->can('cycle.edit'))
                                        ...
                                        @if(Auth::guard('admin')->user()->can('cycle.delete'))
                                   ...
                                   <div class="alert-message" id="name_classes_error"></div>
                                        ...
                                        <input type="hidden" name="id" id="id">
                                            <div class="form-group col-md-6 col-sm-12">
                                                <label for="">Nom du cycle<span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="nom_cycle" name="nom_cycle"  placeholder="Enter le nom d'un cycle ex:Master " required="on" value="" onkeyup="this.value = this.value.toUpperCase();" style="text-transform:uppercase">
                                                <br>
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', '#create-new-post', function () {
        $('#btn-save').val("create-post");
          ...
          $('#postCrudModal').html("Ajouter un cycle");
      ...
      $('body').on('click', '#edit-post', function () {
        ...
        $.get('cycles/'+cycle_id+'/edit', function (data) {
           $('#postCrudModal').html("Editer un Cycle");
            $('#btn-save').val("edit-post");
            $('#ajax-crud-modal').modal('show');
            $('#id').val(data.id);
            $('#nom_cycle').val(data.nom_cycle);
        })
     });
                                    ...
                                    if (e.value === true)
                                     {
                                        ...
                                        $.ajax({
                                        type: 'POST',
                                        url: "{{url('/admin/cycles/delete')}}/" + cycle_id,
                                        ...
                                        success: function (results)
                                     {
                                            if (results.success === true)
                                            {
                                                ...
                                                $("#id_" + cycle_id).remove();
                                                window.location.replace("{{ route('admin.cycles.index') }}");
       ...
       submitHandler: function(form) {
        ...
        swal({
              ...
              window.location.replace("{{ route('admin.cycles.index') }}");
                ...
                var classes = '<tr id="id_' + data.id + '"><td>' + data.nom_cycle + '</td>';
                    classes += '<td><a href="javascript:void(0)" id="edit-post" data-id="' + data.id + '" class="btn btn-info">Modifier</a><a href="javascript:void(0)" id="delete-post" data-id="' + data.id + '" class="btn btn-danger delete-post">Supprimer</a></td>';
                    classes += '</tr>';
