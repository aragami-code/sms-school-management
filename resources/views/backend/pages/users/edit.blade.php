...
@section('title')
Modifier un Utilisateur | tableau de bords
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <li><span>Modifier l'Utilisateur {{$user->name}}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Editer un Utilisateur</h4>
                ...
                <form action="{{route('admin.users.update', $user->id)}}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" id="name" name="name"  placeholder="Enter le nom d'un utilisateur" required="on" value="{{$user->name}}">
                    ...
                    --}}
                        ...
                        <button type="submit" class="btn btn-primary mt-4 pr-4 pl-4">Mettre à jour les informations</button>
                    </form>
                </div>
            </div>
        </div>
