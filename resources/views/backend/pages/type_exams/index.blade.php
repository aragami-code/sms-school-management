...
@section('title')
liste des types d'examens| Tableau de Bord
@endsection
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    @if(Auth::guard('admin')->user()->can('type_exams.create'))
                    <p class="float-right">{{--
                    ...
                    @if(Auth::guard('admin')->user()->can('type_exams.view'))
                    <div class="data-tables">
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody id="posts-crud">
                                ...
                                @foreach ($type_exams as $exams)

                              <tr id="id_{{ $exams->id }}">
                                    <td>{{$exams->name_type_exam}}</td>

                                    <td>

                                        @if(Auth::guard('admin')->user()->can('type_exams.edit'))
                                   ...
                                   <div class="alert-message" id="name_exam_error"></div>
                                        ...
                                        <input type="hidden" name="id" id="id">
                                            <div class="form-group col-md-6 col-sm-12">
                                                ...
                                                <input type="text" class="form-control" id="name_type_exam" name="name_type_exam"  placeholder="ex: Premiere Séquence " required="on" value="">
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', '#create-new-post', function () {
        $('#btn-save').val("create-post");
          ...
          $('#postCrudModal').html("Ajouter un examen");
      ...
      $('body').on('click', '#edit-post', function () {
        ...
        $.get('type_exams/'+exam_id+'/edit', function (data) {
           $('#postCrudModal').html("Editer un examen");
            $('#btn-save').val("edit-post");
            $('#ajax-crud-modal').modal('show');
            $('#id').val(data.id);
            $('#name_type_exam').val(data.name_type_exam);
        })
     });
                                    ...
                                    if (e.value === true)
                                     {
                                        ...
                                        $.ajax({
                                        type: 'POST',
                                        url: "{{url('/admin/type_exams/delete')}}/" + exam_id,
   ...
   if ($("#postForm").length > 0) {
       ...
       submitHandler: function(form) {
        ...
        $.ajax({
            ...
            url: "{{ route('admin.type_exams.store') }}",
            type: "POST",
            dataType: 'json',
        ...
        swal({
                ...
                var annee = '<tr id="id_' +data.id+ '"><td>' +data.name_type_exam+ '</td>';
