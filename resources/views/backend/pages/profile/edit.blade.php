...
@section('title')
Modifier Profil | tableau de bords
@endsection
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Modifier Profil</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('admin.adminprofile.update',Auth::guard('admin')->user()->id)}}" method="POST">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" class="form-control" id="name" name="name"  placeholder="Enter le nom d'un utilisateur" required="on" value="{{$admin->name}}">

                            </div>
                            <div class="form-group col-md-6 col-sm-12">
                                <label for="email">Email</label>
                                <input type="email" class="form-control" id="email" name="email"  placeholder="Enter un email" required="on" value="{{$admin->email}}">
