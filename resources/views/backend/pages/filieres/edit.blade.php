        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Toutes les filieres {{$SFiliere['Sn']['nom_niveau']}}</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">liste des Filieres {{$SFiliere['Sn']['nom_niveau']}}</h4>
                    ...
                    </span>Ajouter une Filiere au cycle {{$SFiliere['Sn']['nom_niveau']}}</a>
                    ...
                    <div class="data-tables">
                        <table id="dataTable" class="text-center">
                            ...
                            <tbody id="posts-crud">
                                ...
                                @foreach ($SFilieres as $filieres)

                              <tr id="id_{{$filieres->id}}">
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" id="edit-post" data-id="{{$filieres->id}}"  class="btn btn-info">  <b><i class="fa fa-edit"></i></b><span>
                                        </span>Modifier</a>
                                       

                                        @endif

                                        @if(Auth::guard('admin')->user()->can('filieres.delete'))

                                          <a href="javascript:void(0)" id="delete-post" data-id="{{ $filieres->id }}" class="btn btn-danger delete-post"> <b><i class="fa fa-trash"></i></b><span>
                                        </span>Suprimer</a>
                            ...
                            <form id="postForm" name="postForm" class="form-horizontal">
                                ...
                                <div class="modal-body">
                                   ...
                                   <div class="alert-message" id="name_classes_error"></div>
                                        ...
                                        <input type="hidden" name="id_niveau" id="id_niveau" value="{{$SFiliere['Sn']['id']}}">
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', '#create-new-post', function () {
       $('#btn-save').val("create-post");
          ...
          $('#postCrudModal').html("Ajouter une filere");
