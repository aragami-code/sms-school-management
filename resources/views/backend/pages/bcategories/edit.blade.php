...
@section('title')
Modifier une Categories | tableau de bords
@endsection
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Categorie</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{route('admin.dashboard')}}">Tableau de Bord</a></li>
                    <li><a href="{{route('admin.bcategories.index')}}">Toutes les categories</a></li>
                <li><span>Modifier la Categorie {{$Bcategory->name}}</span></li>
                </ul>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                ...
                <form action="{{route('admin.bcategories.update', $Bcategory->id)}}" method="POST">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" id="name" name="name"  placeholder="Enter le nom d'un utilisateur" required="on" value="{{$Bcategory->name}}">

                        </div>
                        <div class="form-group col-md-6 col-sm-12">
                            <label for="slug">Slug (Mot cle)</label>
                            <input type="text" class="form-control" id="slug" name="slug"  placeholder="modifier le slug" required="on" value="{{$Bcategory->slug}}">
