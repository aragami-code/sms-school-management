...
@section('title')
liste des Articles du blog| Tableau de Bord
@endsection
        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Tout les Articles</span></li>
                </ul>
            </div>
        </div>
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right">
                    <a class="btn btn-primary text-white" href="{{ route('admin.articles.create')}}">Creer un nouvel Articles</a>
                    </p>
                    @endif
                    ...
                    <div class="data-tables">
                        <table id="dataTable" class="text-center">
                            <thead class="bg-light text-capitalize">
                                <tr>
                                    <th width="3%">SI</th>
                                    <th width="20%">Nom Article</th>
                                    <th width="12%">Image Article</th>
                                    <th width="50%">Description article</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <img src="{{asset("backend/images/blog/$Article->image_article")}}" style="width: 15%; heigth: 100%;"/></td>
                                    <td>{{$Article->sommaire_article}}</td>

                                    <td>

                                        @if(Auth::guard('admin')->user()->can('article.edit'))
                                         {{----}}<a class="btn btn-success text-white" href="{{ route('admin.articles.edit', $Article->id)}}" >Modifier </a>
