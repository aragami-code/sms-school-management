       ...
       submitHandler: function(form) {
        ...
        $('#btn-save').html('traitement...');
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.note_eds.store') }}",
                    type: "POST",
                    dataType: 'json',
                ...
                swal({
                      ...
                      window.location.replace("{{ route('admin.note_eds.index') }}");
                         fill_datatable();
...
function fill_datatable(id_classe = '', id_section = '', id_annee = '', id_gmatiere = '', id_matiere = '', id_type_exams = '', id_evaluation = '')
{
    ...
    var dataTable = $('#dataTable').DataTable({
        ...
        serverSide: true,
        ajax:{
            url: "{{ route('admin.note_eds.index') }}",
...
$('#filter').click(function(){
    ...
    {
       $('#dataTable').DataTable().destroy();
        fill_datatable(id_classe, id_section, id_annee, id_gmatiere , id_matiere , id_type_exams , id_evaluation, noteetu);
...
$(document).on('click', '#edit-post', function () {
    var id = $(this).data('id');
    $.get("{{ route('admin.notes.index') }}" +'/' + id +'/edit', function (data) {
