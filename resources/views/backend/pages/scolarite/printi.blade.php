...
<body>
    ...
    <table width="100%" style="font-family: sans-serif;" cellpadding="10">
        ...
        <tr>
            <td width="100%" style="text-align: center; font-size: 20px; font-weight: bold; padding: 0px;">
             <b style="color: rgb(34, 158, 34)">RECU DE PAYEMENT {{$Etudiant->code_recu}}{{$Etudiant->id}} </b> 
            </td>
        </tr>
    ...
    <table width="100%" style="font-family: sans-serif; font-size: 11px;" >
        ...
        <tr>
            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:30%;"><strong>Montant des droits universitaires/  :  {{$Etudiant->scolarite_total}} {{$parametre->devise_monetaire}}</strong> </td>
           <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:70%;"><strong>Montant en lettre:</strong> <?php
    ...
    <table width="100%" style="font-family: sans-serif; font-size: 11px;" >
        ...
        <tr>
            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:30%;"><strong>Montant cumulé/  : {{$Etudiant->scolarite_cumul}} {{$parametre->devise_monetaire}}</strong> </td>
           <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:70%;"><strong>Montant en lettre:</strong> <?php
                          $t = new NumberFormatter("fr", NumberFormatter::SPELLOUT);
...
<tr>
    <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:30%;"><strong>Reste à payer/  :  {{$Etudiant->reste_scolarite}} {{$parametre->devise_monetaire}}</strong> </td>
   <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:70%;"><strong>Montant en lettre:</strong>   <?php
                          $t = new NumberFormatter("fr", NumberFormatter::SPELLOUT);
