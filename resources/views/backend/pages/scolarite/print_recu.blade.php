...
<body>
    ...
    <a href="#" target="_blank"><img src="{{asset("backend/images/parametres/$parametre->favicon_logo")}}" width="800" height="100"  alt="Logo" align="center" border="0"></a>
            ...
            <td>
                ...
                <table width="100%" style="font-family: sans-serif; font-size: 11px;" >
                    ...
                    <tr>
                       ...
                       <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px; width:50%;"><strong>Mode de payement/ Payment method:</strong>  {{$Etudiant->etat_solde}}</td>
