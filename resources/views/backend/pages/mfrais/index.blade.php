        ...
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <ul class="breadcrumbs pull-left">
                    ...
                    <li><span>Tous les montants des frais de scolarité par classes</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">liste des montants par frais </h4>
                    ...
                    </span>Creer un montant de frais de scolarité</a>
                                    ...
                                    <td></td>
                                      {{--<td>{{$mfrai->name_classes}}</td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-primary text-white" href="{{ route('admin.mfrais.show',Crypt::encrypt($mfrai->id_frais))}}" > <i class="fa fa-eye"></i> Voir</a>
...
<script>
    ...
    $(document).ready(function () {
      ...
      $('body').on('click', '#edit-post', function () {
        ...
        $.get('mfrais/'+mfrais_id+'/edit', function (data) {
           $('#postCrudModal').html("Editer Montant Frais");
   ...
   if ($("#postForm").length > 0) {
       ...
       submitHandler: function(form) {
        ...
        swal({
                ...
                var classes = '<tr id="id_' + data.id + '"><td>' +data.name_classe + '</td><td>' + data.name_frais + '</td><td>'+ data.montant + '</td><td><a href="javascript:void(0)" id="edit-post" data-id="' + data.id + '" >Modifier</a></td>';
                    classes += '</tr>';
