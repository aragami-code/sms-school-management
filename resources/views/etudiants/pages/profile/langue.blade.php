                ...
                <div class="card-body">
                    ...
                    <div class="d-md-flex">
                        <div class="nav flex-column nav-pills mr-4 mb-3 mb-sm-0" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                           ...
                           <a href="{{route('chercheur.experience.index')}}" class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="true">Competences</a>
                          <a class="nav-link active" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="true">Langues parlées</a>
                                    ...
                                    <table class="table table-bordered" id="laravel_crud">
                                     ...
                                     <tbody id="posts-crud">
                                        ...
                                        <tr id="id_{{ $competence->id }}">
                                            <td>{{ $competence->langue }}</td>
                                            <td>{{ $competence->niveau  }}</td>
                                            <td>
                                                <a href="javascript:void(0)" id="edit-post" data-id="{{ $competence->id }}" class="btn btn-info">Modifier</a>
                                                <a href="javascript:void(0)" id="delete-post" data-id="{{ $competence->id }}" class="btn btn-danger delete-post">Supprimer</a>
                                            </td>
   ...
   if ($("#postForm").length > 0) {
       ...
       submitHandler: function(form) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                var langue = '<tr id="id_' + data.id + '"><td>' + data.langue + '</td>'+'</td><td>' + data.niveau+ '</td>';
                    langue += '<td><a href="javascript:void(0)" id="edit-post" data-id="' + data.id + '" class="btn btn-info">Modifier</a><a href="javascript:void(0)" id="delete-post" data-id="' + data.id + '" class="btn btn-danger delete-post">Supprimer</a></td>';
                    langue += '</tr>';
